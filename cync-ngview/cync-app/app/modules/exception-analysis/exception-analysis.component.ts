...
@Component({
    selector: 'exceptionAnalysis-comp',
    templateUrl: './exception-analysis.component.html'
}) export class ExceptionAnalysisComponent { 

constructor(private _router: Router){	
	if(this._router.url == '/exceptionAnalysis'){
		this._router.navigateByUrl(this._router.url+"/dilution-analysis");
	}	
}
	ngOnInit(){
		/*Commenting the particle JS code since its not using currently*/
