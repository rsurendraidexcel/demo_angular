...
import { Country, UpdateRequestBody, State, NaicsCodeCombined, NaicsCode, CorporateType, Guarantors } from '../model/guarantors.model.component'
...
export class GuarantorsService {
    ...
    */
    ...
    /**
    * Method to get the guarantors data
    * 
    */
    getDetails(url: string): Observable<Guarantors> {
        return this._cyncHttpService.get(url).map(data => <Guarantors>JSON.parse(data._body));
    }
