...
import { CrossAgeBucketsGridComponent } from './cross-age-buckets-grid/cross-age-buckets-grid.component';
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';
import { FormGroup, FormBuilder } from '@angular/forms';
import { ClientTemplatesService } from '../../service/client-templates.service';

@Component({
  selector: 'app-ineligible-reasons',
  templateUrl: './ineligible-reasons.component.html',
  styleUrls: ['./ineligible-reasons.component.scss']
})
export class IneligibleReasonsComponent implements OnInit {
  allDropDownData: any
  ...
  openConsiderCrossAgeBucketsDialog() {
    const dialogRef = this.dialog.open(CrossAgeBucketsGridComponent, {
      disableClose: true,
      width: '850px',
     // height: '400px',
