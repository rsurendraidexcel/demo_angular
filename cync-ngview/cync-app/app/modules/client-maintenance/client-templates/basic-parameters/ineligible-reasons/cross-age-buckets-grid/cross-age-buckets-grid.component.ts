...
import { CrossAgeGridInputComponent } from './cross-age-grid-input/cross-age-grid-input.component';
...
export class CrossAgeBucketsGridComponent implements OnInit {
	...
	constructor(private clientTemplatesService: ClientTemplatesService,
		public dialogRef: MatDialogRef<CrossAgeBucketsGridComponent>,
		...
		this.columnDefs = [
			...
			},
			{
				...
				field: 'based_on',
				sortable: true,
				cellRendererFramework: CrossAgeGridInputComponent,
				width: 200
			},
			{
				headerName: 'Action',
