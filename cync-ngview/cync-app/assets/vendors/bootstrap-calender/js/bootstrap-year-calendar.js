 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_renderHeader: function() {
			/*var content = '<div class="row no-marg">'+    
		       	'<div class="col-sm-12 col-md-8 col-xs-12 no-pad">'+
		              '<div class="col-sm-12 col-md-6 col-xs-12">'+
		                    '<div class="year-custom ">'+
		                      '<label class="col-md-12 m-t-10 w-175" >Select year : &nbsp; </label>'+
		                        '<table class="table table-bordered table-style table-responsive">'+
		                          '<tr>'+
		                            '<th colspan="2" class="prev-year" style="border: 1px solid #ddd !important;"><a href="?ym=<?php echo $prev; ?>"><span class="glyphicon glyphicon-chevron-left color-black"></span></a></th>'+
		                            '<th colspan="3">2017</th>'+
		                            '<th colspan="2" class="next-year" style="border: 1px solid #ddd !important;"><a href="?ym=<?php echo $next; ?>"><span class="glyphicon glyphicon-chevron-right color-black"></span></a></th>'+
		                          '</tr>'+
		                        '</table>'+
		                     '</div>'+
		              '</div>'+
		              '<div class="col-sm-12 col-md-6 col-xs-12 text-right m-t-15">'+
		                '<i id="Customize" class="hand fa fa-cog fa-2x clr_grey f_s_24 text-right" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Customize" ></i>'+
		              '</div>+'+
		            '</div>'+
		    '</div>'; */
...
var headerLabel = $(document.createElement('h3'));
			...
			prevDiv.append(prevIcon);
				headerTable.append(headerLabel);
		...
		_renderBody: function() {
			...
			for(var m = 0; m < 12; m++) {
				...
				titleCell.append('<span>'+dates[this.options.language].months[m]+'</span>');
/*
				titleCell.append('<i class="fa fa-arrows-alt" aria-hidden="true"></i>')*/
			...
			switch(this.options.style)
			{
				case 'border':
					...
					if(events.length == 1) {
						...
						/*elt.parent().css('border', '1px solid rgb(128, 0, 0)');*/
							elt.css({
